...
uint256 hashGenesisBlock("0x69f76ab50ebae246bf7f6c29120cba6bbb7e0008ef4582fb4e86b2e444f26601");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Gecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Gecoin Signed Message:\n";
...
{
    // Gecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Gecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Gecoin: 3.5 days
static const int64 nTargetSpacing = 150; // Gecoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Gecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Gecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Gecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7c4a6141e58f41f5327061113aac08095b1f59db3e86280c0bb27fa8a1ef37f5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d414c0114736aaf1ae1306e23a031a888ade76893b0f44f12d98742a65c29250378979346ada3cdfe957c19ed002c8b9639a99285226b66c2e02c998480840898e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1518094583;
        block.nBits    = 504365644;
        block.nNonce   = 2920596757;

        if (fTestNet)
        {
            block.nTime    = 1518094583;
            block.nNonce   = 2692294909;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x448b95c4f1191184ea83176e0387696af07f67ec5ce593c4d28b25dbf6ca6c75"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Gecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GecoinMiner : ProcessBlock, block not accepted");
    }
